        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "nvarchar(205)", maxLength: 205, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.Id);
                    table.CheckConstraint("CK_Movie_PublicationYear", "PublicationYear >= 1888 AND PublicationYear <= YEAR(GETDATE())");
                });
